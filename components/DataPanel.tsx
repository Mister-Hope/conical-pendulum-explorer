    ...
    <div className="bg-slate-900 rounded-xl p-5 border border-slate-800 shadow-lg">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
          ...
          <div className="text-3xl font-mono text-white font-bold">{angularVelocity.toFixed(2)} <span className="text-lg text-slate-500">rad/s</span></div>
        </div>
        <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
          <div className="text-sm text-slate-400 uppercase tracking-wider mb-2 font-bold">
            周期 <Latex>T</Latex>
          </div>
          <div className="text-3xl font-mono text-white font-bold">{period.toFixed(2)} <span className="text-lg text-slate-500">s</span></div>
        </div>
      </div>
        ...
        <table className="w-full text-left">
          <thead className="text-sm text-slate-300 uppercase bg-slate-800">
            <tr>
              ...
              <th className="px-4 py-3">半径 <Latex>r</Latex></th>
              <th className="px-4 py-3">角度 <Latex>\theta</Latex></th>
            </tr>
          </thead>
